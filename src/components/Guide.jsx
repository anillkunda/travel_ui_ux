import { camp, boatImage, meter } from "../assets/images";
    ...
    <section className="flexCenter flex-col">
      ...
      <div className="flexCenter max-container relative w-full">
        <img
          ...
          width={1440}
          height={580}
          className="min-h-64 object-cover object-center 2xl:rounded-5xl"
        />
        ...
        >
          ...
          <div className="flexBetween flex-col">
            ...
            <div className="flex w-full flex-col">
              ...
              <h3 className="bold-18 mt-2 whitespace-nowrap">
                Wonorejo Pasuruan
              </h3>
            </div>
          </div>
